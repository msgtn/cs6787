...
from gps.agent.config import AGENT_CAR
...
class AgentBox2D(Agent):
    ...
    def _setup_world(self, world, target, render):
        ...
        self.env = wrappers.Monitor(self.env, 'flaskapp/static', force=False, resume = True, video_callable=None, mode='evaluation', write_upon_reset=False)
