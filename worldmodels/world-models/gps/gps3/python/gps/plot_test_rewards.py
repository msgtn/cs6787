...
import gps
'''
A general plotter to plot the distribution of test rewards over iterations based on policy.pkl files.
'''

#specify the experiment directory here
dir_exp = '/home/dev/scratch/gpscars/worldmodels/world-models/gps/gps3/experiments/car_world_badmm_workers_3/data_files/pol_sample_itr_*.pkl'
